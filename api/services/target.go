...
func Target(uid string, key string) (types.Target, error) {

	var keyedField types.Target
...
func Targets(uid string) ([]types.Target, error) {

	savedTargets := []types.Target{}
	var keyedField types.Target
...
func SaveTargets(value []types.Target, uid string) error {
...
func deleteTargets(value []types.Target, uid string) error {
