...
func VerifyUsernameAndPassword(user models.Users) (bool, models.Users, error) {

	var keyedField models.Users
	var verifiedUsers models.Users
...
func User(uid string) (models.Users, error) {
...
func SaveUser(value *models.Users) error {
	var err error
