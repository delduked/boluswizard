...
func SaveISFs(value []models.ISF, uid string) error {
...
func ISFs(uid string) ([]models.ISF, error) {

	savedISF := []models.ISF{}
	var keyedField models.ISF
...
func deleteISFs(value []models.ISF, uid string) error {
