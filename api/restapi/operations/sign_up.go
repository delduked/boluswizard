...
func (o *SignUpOKBody) validateData(formats strfmt.Registry) error {
	...
	if o.Data != nil {
		if err := o.Data.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("signUpOK" + "." + "Data")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("signUpOK" + "." + "Data")
			}
			return err
		}
	}
...
func (o *SignUpOKBody) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
